...
<html>
    ...
    <body>
        <nav class="navbar navbar-light" style="background-color: #F2027E;">
            <span class="navbar-brand mb-0 p h1" style="padding-left: 10px;">Online Interactive Display Screen</span>
        </nav>
        
        <div style="background-color:#471147; padding-top: 50px; padding-bottom: 50px" class="container-fluid">
            <h1 style="color: #FE90C9">Online Interactive Display Screen</h1>
            <p>Send something to your display with the form below</p>
